...
public class StickyNavLayout extends LinearLayout {
    ...
    public interface OnScrollListener {
        void onHeaderStatusChanged(boolean isHeaderCompleteVisible);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int vpHeight = getMeasuredHeight() - mNav.getMeasuredHeight();

        params.height = vpHeight > params.height ? vpHeight : params.height;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mInnerScrollView instanceof ScrollView) {
                    ...
                    View c = lv.getChildAt(
                            ((LinearLayoutManager) lv.getLayoutManager()).findFirstVisibleItemPosition());
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if (!isTopHidden || (c != null && c.getTop() == 0 && dy > 0)) {
                        ...
                        if (layoutManager instanceof LinearLayoutManager) {
                            ...
                            throw new IllegalArgumentException(
                                    "StikyNavLayout---->RecyclerView's LayoutManager must be LinearLayoutManager");
                        }
                        ...
                        // 或sc的listView在顶部 && topView隐藏 && 下拉，则拦截
          /*  Log.d("stickynav",
                "isTopHidden:" + isTopHidden + "  c.getTop():" + (c != null ? String.valueOf(
                    c.getTop()) : "is null ") + " dy:" + dy);
*/
                        if (!isTopHidden || (c != null && c.getTop() == 0 && dy > 0)) {
    ...
    private void getCurrentScrollView() {
        ...
        if (a instanceof FragmentPagerAdapter) {
            ...
            mInnerScrollView =
                    (ViewGroup) (item.getView().findViewById(R.id.id_stickynavlayout_innerscrollview));
    ...
    public void scrollTo(int x, int y) {
        ...
        if (null != mOnScrollListener) {
            mOnScrollListener.onHeaderStatusChanged(getScrollY() == 0);
        }
    }
